...
def parse_config():
    ...
    cfg_file = os.getcwd()+"/tools/cfgs/rio_configs/rio_model.yaml"  # hard code our cfg file
    #cfg_file = os.getcwd()+"/tools/cfgs/scannet_configs/scannet_model.yaml"
    cfg_from_yaml_file(cfg_file, cfg) # save to cfg
...
def main():
    args, cfg, cfg_file = parse_config()
    ...
    train_set, train_loader, train_sampler = build_dataloader(
        ...
        logger=logger,
        root_path=cfg.DATA_CONFIG.ROOT_PATH,
        training=True,
